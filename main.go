...
const (
	Name              = "ct-oos-go"
	Description       = "基于 Go 语言开发的 天翼云 对象存储（经典版）I型 命令行工具"
	URL               = "https://github.com/xuxiaowei-com-cn/ct-oos-go.git"
	BugReportUrl      = "https://github.com/xuxiaowei-com-cn/ct-oos-go/issues"
