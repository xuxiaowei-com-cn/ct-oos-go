...
func PutObjectFromFile(accessKey string, secretKey string, endpoint string, bucketName string, uri string, file string,
	force bool, connectTimeoutSec int64, readWriteTimeoutSec int64) error {
